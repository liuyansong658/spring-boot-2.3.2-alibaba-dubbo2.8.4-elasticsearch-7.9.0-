...
public class ElasticSearchTest {
    ...
    public static void main(String[] args) throws IOException {
         ...
         * 创建索引库结构
         */
        ElasticSearchTest elasticSearchClient =new ElasticSearchTest();
         ...
         * 导入数据
         */
        TestInfo baseInfo1 =new TestInfo(1L,"2020-11-03","张三",1,"2020-12-25");
//        Phone phone1=new Phone(1L,"150123456789");
//        JsonBo jsonBo1=new JsonBo();
//        jsonBo1.setBaseInfo(baseInfo1);
//        jsonBo1.setPhoneList(phone1);
        elasticSearchClient.addDoc(indexName, JSONUtil.toJsonStr(baseInfo1));
    ...
    public ElasticSearchTest() {
        ...
        //若节点不为空则进行拆分
        this.esNodes = "10.65.213.34:9200";
